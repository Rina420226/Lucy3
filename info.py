...
BOT_TOKEN = environ.get('BOT_TOKEN', "8082647725:AAGKGeWVQsbIjYPjqdXolNqUpCODYSpgNk0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003851417702').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003528396267'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003841098375'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003744185460'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003818246798')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003838765623') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5229672630') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jamessmithssp:jamessmithssp@cluster0.lemow.mongodb.net")
DATABASE_NAME = environ.get('DATABASE_NAME', "NB_database")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rinamurmu231:rinamurmu231@badsha.xp8bc.mongodb.net")
DB_CHANGE_LIMIT = int(environ.get('DB_CHANGE_LIMIT', "432")) 

GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesrequestgroup2026')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+QSBrEgPylvhhMjI1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/studu01')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/movieupdateschh')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003712131648'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003801428188'))
...
SHORTENER_API = environ.get("SHORTENER_API", "8d500e31aa3b86058468ea226626678e3c44fd20")
