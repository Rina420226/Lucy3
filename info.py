...
PICS = (environ.get('PICS', 'https://files.catbox.moe/nynaku.jpg')).split()  # Sample pic
...
SHORTLINK_API = environ.get('SHORTLINK_API', '79bfe9f22cb7a7177ad37f940cbc203ec8631610')
...
PM_SEARCH = bool(environ.get('PM_SEARCH', True))  # PM Search On (True) / Off (True)
